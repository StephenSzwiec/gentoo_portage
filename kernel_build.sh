...
genkernel --kernel-config=config-arch-64 --makeopts='-j8' --luks --lvm all
...
genkernel --kernel-config=config-arch-64 --makeopts='-j8' --luks --lvm --kerneldir=/usr/src/linux-$kernelversion-gentoo-gnu/ all
